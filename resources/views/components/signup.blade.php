...
<div class="form1 bg-white d-flex justify-content-center align-content-center w-50" >
        <div class="w-50 d-flex flex-column align-items-center justify-content-center">
            <div class="">
        <h4 class="mb-5 fw-bold">Create-Account</h4>
        </div>
        ...
        <div class="w-100 ">
            ...
            <p>Dont't have an account? <a href="" class="fw-bold signup text-decoration-none">Create Account</a></p>
        </div>
        </div>
</div>
</div>
