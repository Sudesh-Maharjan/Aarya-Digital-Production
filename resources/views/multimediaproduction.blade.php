...
<x-dmerketingcomp subtitle="Animation" />
<x-dmerketingcomp subtitle="Photography" />
<x-dmerketingcomp subtitle="Videography" />
<x-dmerketingcomp subtitle="Songs" />
<x-dmerketingcomp subtitle="Jingle" />
</div>

<x-getstartedproject/>

<h2 class="fw-bold text-center my-5">Advantage of Multimedia Production For Business Promotion</h2>
<div class="d-flex justify-content-center">
<div class="w-50">
...
<div class="d-flex justify-content-center">
<img src="images/multimediaproduction.png" alt="">
</div>
